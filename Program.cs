           ...
           try
            {
                ...
                Console.WriteLine("Enter a Custom Regex: ");              // Enter [abc]
                string reg = Console.ReadLine();
                Console.WriteLine("Enter text to check with custom regex: ");        //Enter acbuycuafhbfd
